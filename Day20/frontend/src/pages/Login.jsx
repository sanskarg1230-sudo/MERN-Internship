...
const Login = () => {
  ...
  return (
    <div className="min-h-[calc(100vh-64px)] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      {/* Background blobs */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-lg h-full -z-10 opacity-30 dark:opacity-10 blur-3xl rounded-full bg-gradient-to-r from-primary-400 to-purple-500 pointer-events-none"></div>
